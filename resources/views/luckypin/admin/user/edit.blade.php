    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <form action="{{route('luckypin.admin.users.update', $item->id)}}" method="post" data-toggle="validator">
                    @method('PUT')
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr class="{{$class}}">
                                ...
                                <td><a href="{{route('luckypin.admin.orders.edit',$order->id)}}"><i class="fa fa-fw fa-eye"></i></a></td>
                            </tr>
                                @endforeach
                            </tbody>
                        </table>
