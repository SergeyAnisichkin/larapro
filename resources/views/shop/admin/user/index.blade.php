                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <td>{{$user->role}}</td>
                            <td>
                               <a href="{{route('shop.admin.users.edit',$user->id)}}" title="просмотреть пользователя"><i class="btn btn-xs"></i>
                                   <button type="submit" class="btn btn-success btn-xs">Просмотреть</button>
                               </a>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                <a class="btn btn-xs">
                                    <form method="post" action="{{route('shop.admin.users.destroy', $user->id)}}"
                                          style="float: none">
                                        @method('DELETE')
                                        @csrf
