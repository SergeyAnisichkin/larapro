                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            ...
                            <input type="hidden" name="_token" value="VxbpVBQdEaaaIS46t0DqG4K6PFtNnnFCOMLxREaE">            </form>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <p>
                            <form action="http://internet-shop.tmweb.ru/basket/add/5" method="POST">
                                ...
                                <a href="http://internet-shop.tmweb.ru/portable/beats_audio"
                                   class="btn btn-default"
                                   role="button">Подробнее</a>
                                <input type="hidden" name="_token" value="VxbpVBQdEaaaIS46t0DqG4K6PFtNnnFCOMLxREaE">
                            </form>
                        </p>
                    </div>
                </div>
